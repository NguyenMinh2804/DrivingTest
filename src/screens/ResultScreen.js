  ...
  return (
    <SafeAreaView
      ...
      <View
        ...
        {isImportant && <Text style={{ color: COLORS.error }}>*Sai câu liệt</Text>}
        <Text style={{ marginTop: 5, fontSize: 15, color: COLORS.black }}>
          Số câu đúng: <Text style={{ color: 'blue' }}>{correctCount}/25 </Text>
          - Thời gian làm bài: <Text style={{ color: 'blue' }}>{Math.floor((1140 - timer) / 60)}' {Math.floor((1140 - timer) % 60)}s</Text></Text>
      </View>
      <FlatList
        data={questions}
        style={{
